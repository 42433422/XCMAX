...
- docs(release): macOS 发布 SSOT 回填 1.0.0.2 正式交付——run 34732266439 构建+签名+公证成功，step14 CVM 直传 10KB/s 超时失败改 artifact 本机中转补齐（双目录 SHA256 核验、公网 feed buildSha 6eda2203d、ed25519 验签 VALID、官方包 spctl accepted/stapler OK），G3 转 GREEN
