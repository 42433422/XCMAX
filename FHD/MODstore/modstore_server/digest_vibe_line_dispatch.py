...
def dispatch_vibe_prep_to_production_lines(
    ...
    enabled = (__import__("os").environ.get("MODSTORE_DAILY_VIBE_LINE_DISPATCH_ENABLED", "1") or "").strip().lower()
    if enabled in ("0", "false", "no", "off"):
        return {"ok": False, "skipped": True, "reason": "MODSTORE_DAILY_VIBE_LINE_DISPATCH_ENABLED=0"}
