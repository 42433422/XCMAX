...
from modman.employee_sandbox import employee_stub_stem, mod_backend_entry_py_path
...
def _stub_module_body(emp_id: str, _safe_mod: str) -> str:
    return (
...
def run_workflow_employee_scaffold(
    ...
    *,
    ...
    safe_mod = employee_stub_stem(emp_id)
    ...
    bp_path = mod_backend_entry_py_path(mod_dir, manifest)
    if bp_path.is_file():
