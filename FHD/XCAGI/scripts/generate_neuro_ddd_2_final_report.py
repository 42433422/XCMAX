...
def generate_final_report():
    ...
    print(
        f"   {'总计':25} {total_passed}/{total_tests}     {total_passed / total_tests * 100:.1f}%"
    )
    ...
    print("   ```python")
    print(
        "   from app.neuro_domains.deep_learning_service import create_default_hybrid_model, ModelInput"
    )
    print("")
