...
def generate_test_report():
    ...
    test_categories = {
        ...
        "域依赖关系测试": {
            ...
            "passed": 2,
            "failed": 0,
            "tests": ["test_domain_dependency_creation", "test_domain_dependency_chain"],
        },
        "协同执行结果测试": {
            "total": 2,
            "passed": 2,
            "failed": 0,
            "tests": ["test_coordination_result_creation", "test_coordination_result_with_metrics"],
        },
        "性能指标测试": {
            "total": 2,
            "passed": 2,
            "failed": 0,
            "tests": ["test_dependency_analysis_performance", "test_coordination_performance"],
        },
    }
