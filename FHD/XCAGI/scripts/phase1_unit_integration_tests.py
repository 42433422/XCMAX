...
class Phase1TestRunner:
    ...
    def __init__(self):
        ...
        self.report_file = (
            Path("test_reports") / f"phase1_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
        )
        self.test_results = {}
    ...
    def run_command(self, command, description, timeout=300):
        ...
        try:
            ...
            return {"success": False, "duration": duration, "error": "测试超时"}
    ...
    def run_unit_tests(self):
        ...
        unit_test_commands = [
            ("pytest tests/neuro_optimization/ -m unit -v --tb=short", "神经突触协同机制单元测试"),
            (
    ...
    def run_integration_tests(self):
        ...
        integration_test_commands = [
            ("pytest tests/neuro_optimization/ -m integration -v --tb=short", "神经域协同集成测试"),
            (
    ...
    def calculate_coverage(self):
        ...
        coverage_commands = [
            ...
            ("pytest tests/neuro_optimization/ --cov=app --cov-report=html", "生成HTML覆盖率报告"),
        ]
    ...
    def generate_report(self):
        ...
        # 统计测试结果
        unit_success = sum(
            1 for r in self.test_results.get("unit_tests", {}).values() if r["success"]
        )
        unit_total = len(self.test_results.get("unit_tests", {}))

        integration_success = sum(
            1 for r in self.test_results.get("integration_tests", {}).values() if r["success"]
        )
        ...
        report = {
            ...
            "summary": {
                ...
                "integration_tests": {
                    ...
                    "success_rate": (integration_success / integration_total * 100)
    ...
    def print_summary(self, report):
        ...
        # 总体评估
        overall_success = (
            unit_summary["success_rate"] > 80 and integration_summary["success_rate"] > 70
        )
