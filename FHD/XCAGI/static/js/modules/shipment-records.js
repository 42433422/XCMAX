...
(function() {
    ...
    function renderCurrentSheet() {
        ...
        if (!currentRecords || !currentSheetNames.length) {
            ...
            if (tbody) tbody.innerHTML = '<tr><td colspan="1" class="empty-state">请先选择客户并加载</td></tr>';
            return;
        }
    ...
    function onShipmentRecordUnitChange() {
        ...
        if (getCardTitle()) getCardTitle().textContent = '选择客户后点击「查看记录」加载数据';
    }
