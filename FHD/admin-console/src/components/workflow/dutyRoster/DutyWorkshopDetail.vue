...
import { YUANGON_AREAS } from '@host/domain/yuangonDutyRoster'

const emit = defineEmits<{
  (e: 'update:selectedWorkshop', v: Deref<DutyRosterState['selectedWorkshop']>): void
}>()

const props = defineProps<{
  selectedWorkshop: Deref<DutyRosterState['selectedWorkshop']>
  viewMode: Deref<DutyRosterState['viewMode']>
  workshopRouteCopied: Deref<DutyRosterState['workshopRouteCopied']>
  selectedWorkshopLinkedEmployees: Deref<DutyWorkshop['selectedWorkshopLinkedEmployees']>
  selectedWorkshopRouteHref: Deref<DutyWorkshop['selectedWorkshopRouteHref']>
  openSelectedWorkshopInClient: Deref<DutyWorkshop['openSelectedWorkshopInClient']>
  copySelectedWorkshopRoute: Deref<DutyWorkshop['copySelectedWorkshopRoute']>
  focusEmployeeFromWorkshop: Deref<DutyWorkshop['focusEmployeeFromWorkshop']>
}>()
