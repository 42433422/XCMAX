...
INTENT_DESCRIPTIONS = {
    ...
    # ─── 订单 CRUD 意图（2026-07-21 新增） ─────────────────────────
    "order_delete": "删除订单、取消订单、撤销订单、移除订单",
    "order_update": "修改订单、更新订单、编辑订单、改订单",
    "order_list": "查询订单、订单列表、查看订单、搜索订单",
    # ─── 客户 CRUD 意图（2026-07-21 新增） ─────────────────────────
    "customer_update": "修改客户、更新客户、编辑客户、改客户信息",
    "customer_delete": "删除客户、移除客户、清掉客户",
    # ─── 报表配置意图（2026-07-21 新增） ───────────────────────────
    "report_config": "配置报表、设置报表、报表参数、报表配置、调整报表",
    # ─── RBAC 权限管理意图（2026-07-21 新增） ──────────────────────
    "role_manage": "创建角色、修改角色、删除角色、分配权限、调整权限、角色管理、权限管理",
}
