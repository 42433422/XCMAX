...
class AgentOrchestrator(RunLifecycleMixin, ArtifactAttachmentMixin):
    ...
    def start_task_from_plan(
        ...
        *,
        ...
        Unlike an autonomous run, a task created for the visible taskbar never
        executes its first tool before the user confirms it.  The existing
        action-bound approval grant then provides the only continuation path.
        """
