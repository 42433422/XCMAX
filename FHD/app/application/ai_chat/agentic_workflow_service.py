"""Agentic workflow run lifecycle and trace bridge."""
...
class AIChatAgenticWorkflowService:
    def __init__(self) -> None:
        self._output_message: Callable[[Any], str] | None = None

    def bind_output_message(self, output_message: Callable[[Any], str]) -> None:
        self._output_message = output_message

    def _workflow_output_message(self, output: Any) -> str:
        if self._output_message is None:
            return ""
        return self._output_message(output)
...
__all__ = ["AIChatAgenticWorkflowService"]
