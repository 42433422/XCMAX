"""Chat persistence, enrichment, fallback, and multimodal support."""
...
class AIChatSupportService:
    _HEADER_HINT_RE = re.compile(
        r"(产品|名称|规格|型号|编号|单价|价格|调价|金额|单位|客户|厂名|品名)"
    )

    def __init__(self, start_deterministic_import_agent_run: Callable[..., dict[str, Any]]) -> None:
        self._start_deterministic_import_agent_run = start_deterministic_import_agent_run
