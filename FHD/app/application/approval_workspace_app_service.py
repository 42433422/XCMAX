...
from app.application import approval_workspace_ai_workflows as _ai_workflows
...
_drop_pending_ai_workflow_after_rejection = _ai_workflows.drop_pending_ai_workflow_after_rejection
_durable_ai_workflow_link = _ai_workflows.durable_ai_workflow_link
_has_pending_ai_workflow = _ai_workflows.has_pending_ai_workflow
