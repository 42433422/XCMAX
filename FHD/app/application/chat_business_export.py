"""Verified attendance export and print operations for business chat."""
...
from app.application.chat_business_attendance import (
...
def _create_attendance_export(rows: list[dict[str, Any]], meta: dict[str, Any]) -> tuple[Path, str]:
    ...
    output = safety.resolve_safe_workspace_relpath(relpath)
...
def _handle_attendance_print(
    ...
    try:
        ...
        service = safety._get_printer_service()
