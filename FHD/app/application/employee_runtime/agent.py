...
class EmployeeAgent:
    ...
    def _build_agent_tools(
        ...
        try:
            ...
            logger.debug("build agent tools fallback", exc_info=True)
            return None
    ...
    def _build_agent_gate(
        ...
        try:
            ...
            logger.debug("build workspace gate fallback", exc_info=True)
        try:
            ...
            logger.debug("build write gate fallback", exc_info=True)
        try:
    ...
    def _run_upstream_collaboration(
        ...
        try:
            ...
            logger.debug("upstream collaboration skipped", exc_info=True)
            return None
    ...
    def _perceive(self, config: dict[str, Any], payload: dict[str, Any]) -> dict[str, Any]:
        try:
            ...
            logger.debug("perception fallback", exc_info=True)
            return _ex._perception_real(config, payload)
