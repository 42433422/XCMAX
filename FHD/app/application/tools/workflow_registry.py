"""Declarative workflow tool schemas.

Runtime cache ownership remains in ``workflow.py`` so the public compatibility
facade stays patchable while schema declarations remain isolated and testable.
"""
