...
class EtlRun(TimestampMixin, TenantScopedMixin, Base):
    ...
    operation_kind: Mapped[Optional[str]] = mapped_column(String(16))
    operation_token: Mapped[Optional[str]] = mapped_column(String(36))
    operation_lease_until: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True))
