"""Mobile AI 群聊 CRUD / Git 分支 / 会话状态 routes (split from mobile_api_extensions).
...
@ai_group_router.get("/git/branches")
...
@ai_group_router.get("/ai-groups/candidates")
async def mobile_ai_group_candidates(request: Request, user=Depends(get_mobile_user)):
    ...
    try:
        candidates = mext.AiGroupChatService(mode=mext._mobile_group_mode(request)).list_member_candidates()
...
@ai_group_router.post("/ai-groups")
async def mobile_ai_groups_create(
    ...
    try:
        group = mext.AiGroupChatService(mode=mext._mobile_group_mode(request)).create_group(
...
@ai_group_router.get("/ai-groups/{group_id}/messages")
async def mobile_ai_group_messages(
    ...
    try:
        messages = mext.AiGroupChatService(mode=mext._mobile_group_mode(request)).get_messages(
...
@ai_group_router.post("/ai-groups/{group_id}/messages")
async def mobile_ai_group_post(
    ...
    try:
        ...
        result = await mext.AiGroupChatService(mode=mext._mobile_group_mode(request)).post_message(
            user_id=uid,
            group_id=group_id,
            text=body.message,
...
@ai_group_router.post("/ai-groups/{group_id}/members")
async def mobile_ai_group_add_member(
    ...
    try:
        group = mext.AiGroupChatService(mode=mext._mobile_group_mode(request)).add_member(
            user_id=uid,
            group_id=group_id,
            member={
...
@ai_group_router.delete("/ai-groups/{group_id}/members/{employee_id}")
async def mobile_ai_group_remove_member(
    ...
    try:
        group = mext.AiGroupChatService(mode=mext._mobile_group_mode(request)).remove_member(
...
@ai_group_router.put("/ai-groups/{group_id}/pin")
async def mobile_ai_group_toggle_pin(
    ...
    try:
        group = mext.AiGroupChatService(mode=mext._mobile_group_mode(request)).toggle_pinned(
...
@ai_group_router.post("/ai-groups/{group_id}/mark-unread")
async def mobile_ai_group_mark_unread(
    ...
    try:
        group = mext.AiGroupChatService(mode=mext._mobile_group_mode(request)).mark_unread(
            user_id=uid, group_id=group_id
        )
        return format_mobile_response(data={"group": group})
    except ValueError as exc:
...
@ai_group_router.post("/ai-groups/{group_id}/mark-read")
async def mobile_ai_group_mark_read(request: Request, group_id: str, user=Depends(get_mobile_user)):
    ...
    try:
        group = mext.AiGroupChatService(mode=mext._mobile_group_mode(request)).mark_read(
            user_id=uid, group_id=group_id
        )
        return format_mobile_response(data={"group": group})
    except ValueError as exc:
...
@ai_group_router.put("/ai-groups/{group_id}/followed")
async def mobile_ai_group_toggle_followed(
    ...
    try:
        group = mext.AiGroupChatService(mode=mext._mobile_group_mode(request)).toggle_followed(
            user_id=uid, group_id=group_id
        )
        return format_mobile_response(data={"group": group})
    except ValueError as exc:
...
@ai_group_router.put("/ai-groups/{group_id}/hidden")
async def mobile_ai_group_toggle_hidden(
    ...
    try:
        group = mext.AiGroupChatService(mode=mext._mobile_group_mode(request)).toggle_hidden(
            user_id=uid, group_id=group_id
        )
        return format_mobile_response(data={"group": group})
    except ValueError as exc:
...
@ai_group_router.delete("/ai-groups/{group_id}")
async def mobile_ai_group_delete(request: Request, group_id: str, user=Depends(get_mobile_user)):
    ...
    try:
        result = mext.AiGroupChatService(mode=mext._mobile_group_mode(request)).delete_group(
            user_id=uid, group_id=group_id
        )
        return format_mobile_response(data=result)
    except ValueError as exc:
...
@ai_group_router.put("/conversations/{conversation_id}/pin")
...
@ai_group_router.post("/conversations/{conversation_id}/mark-unread")
...
@ai_group_router.post("/conversations/{conversation_id}/mark-read")
...
@ai_group_router.put("/conversations/{conversation_id}/followed")
...
@ai_group_router.put("/conversations/{conversation_id}/hidden")
...
@ai_group_router.delete("/conversations/{conversation_id}")
