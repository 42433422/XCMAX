...
from app.infrastructure.persistence.user_memory_vector_runtime import (
    default_user_memory_vector_db_path as _default_user_memory_vector_db_path,
)
...
def get_user_memory_pg_vector_store() -> PgUserMemoryVectorStore:
    """与主库 / Excel 向量一致：对 VECTOR_DB_URL 应用当前请求的 Mod 选库规则。"""
    global _user_memory_pg_vector_store_instance, _user_memory_pg_bound_url
    ...
    want = database_url_for_active_extension(base)
    if _user_memory_pg_vector_store_instance is None or (_user_memory_pg_bound_url or "") != want:
        ...
        _user_memory_pg_bound_url = want
