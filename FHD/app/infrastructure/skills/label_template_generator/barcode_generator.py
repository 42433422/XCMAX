...
class BarcodeGenerator:
    ...
    def generate(self, data: str, options: dict | None = None) -> Image.Image | None:
        """
        生成条形码图像
    ...
    def _generate_fallback_barcode(self, data: str, options: dict | None = None) -> Image.Image:
        """
    ...
    def save(self, filename: str, data: str, options: dict | None = None) -> bool:
        """
        保存条形码为图片文件
...
def generate_barcode(
    data: str, barcode_type: str = "code128", options: dict | None = None
) -> Image.Image | None:
    """
    便捷函数：生成条形码
...
def save_barcode(
    filename: str, data: str, barcode_type: str = "code128", options: dict | None = None
) -> bool:
    """
    便捷函数：保存条形码到文件
