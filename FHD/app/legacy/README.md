...
| `app/domain/shipment/legacy_vo.py` | `app/legacy/domain/legacy_vo.py` | 涂料行业值对象迁移到 `app/domain/value_objects/` 分层模块、移除对 `app.legacy.domain.value_objects_compat` 的转发后 | Shipment Domain |
