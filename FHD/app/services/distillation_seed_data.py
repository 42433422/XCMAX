...
INTENT_LABELS = [
    ...
    "print_label", "upload_file", "materials", "shipment_template", "excel_decompose",
    "show_images", "show_videos", "greet", "goodbye", "help", "negation",
    "customer_export", "customer_edit", "customer_supplement",
]

SAMPLE_QUERIES = {
    "shipment_generate": ["生成发货单给七彩乐园", "开发货单，3桶规格20的PE白底漆", "帮侯雪梅开一张发货单", "做出货单，5桶20kg规格的", "打单给向总", "发货单七彩乐园2桶28规格", "我要给恒达公司开单", "生成一张发货单，客户是利民厂", "帮客户做发货单，数量3桶"],
    "customers": ["查看客户列表", "购买单位有哪些", "显示所有客户", "我想看客户信息", "客户名单在哪", "都有哪些购买单位"],
    "products": ["查看产品列表", "产品库有哪些", "显示产品规格", "产品型号有什么", "PE白底漆的规格", "查一下产品信息"],
