...
instrument_service_layer_class(AIOptimizedService, "app.services.service_optimizers")
instrument_service_layer_class(CustomerServiceOptimizer, "app.services.service_optimizers")
instrument_service_layer_class(ShipmentServiceOptimizer, "app.services.service_optimizers")
