...
_BUSINESS_DB_ENTITY_ALIASES = {'customer': 'customers', 'customers': 'customers', 'purchase_unit': 'customers', 'purchase_units': 'customers', '客户': 'customers', '单位': 'customers', '购买单位': 'customers', 'product': 'products', 'products': 'products', '产品': 'products', '物料': 'materials', '原材料': 'materials', 'material': 'materials', 'materials': 'materials', 'shipment': 'shipment_records', 'shipments': 'shipment_records', 'shipment_record': 'shipment_records', 'shipment_records': 'shipment_records', '出货': 'shipment_records', '发货': 'shipment_records', '发货单': 'shipment_records'}

_BUSINESS_DB_CONTROL_FIELDS = frozenset({'selector', 'changes', 'fields', 'force', 'confirm', '_selector_field', '_resolved_target'})

_RECENT_BUSINESS_DB_TARGETS: dict[str, dict[str, Any]] = {}

_REGISTERED_WORKFLOW_ROUTERS: dict[str, Callable[..., dict]] = _WorkflowRouterMap({'normal_slot_dispatch': _registered_router_normal_slot_dispatch, 'customers': _registered_router_customers, 'products': _registered_router_products, 'materials': _registered_router_materials, 'inventory': _registered_router_inventory, 'purchase': _registered_router_purchase, 'sales': _registered_router_sales, 'reports': _registered_router_reports, 'finance': _registered_router_finance, 'mrp': _registered_router_mrp, 'suppliers': _registered_router_suppliers, 'shipment_records': _registered_router_shipment_records, 'shipment_orders': _registered_router_shipment_orders, 'business_event': _registered_router_business_event, 'system_maintenance': _registered_router_system_maintenance, 'business_docking': _registered_router_business_docking_family, 'template_extract': _registered_router_business_docking_family, 'excel_analyzer': _registered_router_excel_analyzer, 'excel_toolkit': _registered_router_excel_toolkit, 'label_template_generator': _registered_router_label_template_generator, 'document_template': _registered_router_document_template, 'template_preview': _registered_router_template_preview, 'print': _registered_router_print, 'printer_list': _registered_router_printer_list, 'settings': _registered_router_settings, 'employee': _registered_router_employee, 'business_db': _registered_router_business_db, 'dataset_rag': _registered_router_dataset_rag, 'memory_v2': _registered_router_memory_v2, 'excel_analysis': _registered_router_excel_analysis, 'generate_office_document': _registered_router_generate_office_document, 'excel_vector_index': _registered_router_excel_vector_index, 'ocr': _registered_router_ocr, 'excel_import': _registered_router_excel_import, 'unit_products_import': _registered_router_unit_products_import})
