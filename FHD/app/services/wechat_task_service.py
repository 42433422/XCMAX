...
class WechatTaskService(NeuroEventPublisherMixin):
    """微信任务服务类"""
    ...
    def scan_messages(
        ...
        try:
            ...
            os.path.dirname(os.path.dirname(os.path.dirname(__file__)))  # XCAGI 根目录
...
instrument_service_layer_class(WechatTaskService, "app.services.wechat_task_service")
