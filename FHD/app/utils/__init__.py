...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "get_logger": ("app.utils.logging.logger", "get_logger"),
    "log_operation": ("app.utils.logging.logger", "log_operation"),
    "setup_structured_logging": ("app.utils.logging.logger", "setup_structured_logging"),
