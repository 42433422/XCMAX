...
> 自动生成，请勿手改；源 `FHD/scripts/dev/gen_claimed_vs_actual.py`；生成于 2026-07-13T19:38:47Z
...
| 健康探针 /api/health | P50 < 500ms 预算 | 32.59ms（status 200） | sla-snapshot.json#probe.probe_result.health | 🟢 |
