...
> 自动生成，请勿手改；源 `FHD/scripts/dev/gen_claimed_vs_actual.py`；生成于 2026-06-21T17:03:32Z
...
| 健康探针 /api/health | P50 < 500ms 预算 | 3.05ms（status 200） | sla-snapshot.json#probe.probe_result.health | 🟢 |
