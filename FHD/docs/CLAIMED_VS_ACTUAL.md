...
> 自动生成，请勿手改；源 `FHD/scripts/dev/gen_claimed_vs_actual.py`；生成于 2026-09-10T12:46:26Z
...
| DORA 部署频率 | 持续交付 | 环境 production / 窗口 7d / 事件 1 / 频率 0.1429/d / 0 天内采集 | dora-20260910.json | 🟢 |
