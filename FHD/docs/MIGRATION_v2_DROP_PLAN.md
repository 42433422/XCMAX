...
> **状态（2026-06）**：应用层 `*_app_service_v2.py` 已删除。HTTP、planner、tooling 统一使用无后缀 application service 或领域/路由 SSOT；不再维护 V1/V2 双轨登记表。
...
- 既有业务能力优先合并进现有无后缀 application service、`app/fastapi_routes/domains/` 或明确的 domain SSOT。
