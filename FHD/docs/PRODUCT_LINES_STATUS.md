...
> 生成时间：2026-09-18 22:41 UTC ｜ 生成器：`FHD/scripts/dev/product_lines_status.py`
...
|--------|--------|------|---------------------|----------|----------|----------|
| **企业桌面 ERP + AI** | P0 | 主交付 | 9/32 | verified 9 / partial 10 / implemented 13 / planned 0 | macos: GREEN 10 / YELLOW 3 / RED 0 / 未复测 0；windows: GREEN 13 / YELLOW 0 / RED 0 / 未复测 0 | 是 |
...
共 50 项能力 / 26 模块 / 10 域；已验证 13、部分验证 15、已实现待验证 21、规划中 1。
