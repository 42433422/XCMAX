#!/bin/bash
# T6 重启复验（G12）：重启 Mac 后验证核心功能——健康、版本、登录、Mod、业务 API、数据保留
...
EV="/Users/Shared/XCMAX/FHD/docs/evidence/e2e/macos-release-1.0.0.3"
