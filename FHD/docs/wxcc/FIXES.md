...
详细参考：[`assets/IMAGES_GUIDE.md`](../WXCC/assets/IMAGES_GUIDE.md)
...
详细参考：[`assets/ICONS_SETUP.md`](../WXCC/assets/ICONS_SETUP.md)
...
当前请求地址：`http://127.0.0.1:5000/api/mp/v1/products/list`
...
2. **添加占位图片**
   - 参考 [`assets/PLACEHOLDER_GUIDE.md`](../WXCC/assets/PLACEHOLDER_GUIDE.md)
   - 使用在线占位图服务
...
如有问题，请参考：
- [`README.md`](../WXCC/README.md) - 项目说明
- [`GUIDE.md`](../WXCC/GUIDE.md) - 使用指南
- [`SUMMARY.md`](../WXCC/SUMMARY.md) - 功能总结
