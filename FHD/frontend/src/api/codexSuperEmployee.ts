...
function codexEndpoint(scope: CodexSuperEmployeeApiScope = 'admin'): string {
  return scope === 'mobile' ? '/api/mobile/v1/admin/codex-super-employee/messages' : '/api/admin/codex-super-employee/messages'
}
...
export async function fetchCodexSuperEmployeeMessages(options: CodexSuperEmployeeApiOptions = {}): Promise<CodexSuperEmployeeMessage[]> {
