...
function cursorEndpoint(scope: CursorSuperEmployeeApiScope = 'admin'): string {
  return scope === 'mobile' ? '/api/mobile/v1/admin/cursor-super-employee/messages' : '/api/admin/cursor-super-employee/messages'
}
...
export async function fetchCursorSuperEmployeeMessages(options: CursorSuperEmployeeApiOptions = {}): Promise<CursorSuperEmployeeMessage[]> {
