...
export const SUPER_CLI_TOOLS: SystemEmployeeEntry[] = [
...
export function isCodexSuperEmployeeEntry(
  entry: PinnedImEntry,
): entry is CodexSuperEmployeeEntry {
  return 'is_codex_super_employee' in entry && entry.is_codex_super_employee;
}

export function isClaudeSuperEmployeeEntry(
  entry: PinnedImEntry,
): entry is ClaudeSuperEmployeeEntry {
  return 'is_claude_super_employee' in entry && entry.is_claude_super_employee;
}

export function isCursorSuperEmployeeEntry(
  entry: PinnedImEntry,
): entry is CursorSuperEmployeeEntry {
...
export function superEmployeeAvatarKey(
  entry: PinnedImEntry,
...
export function latestCodexDispatcherMessage(
...
export function latestCodexResultMessage(
  items: CodexSuperEmployeeMessage[],
  requestId = '',
): CodexSuperEmployeeMessage | null {
  const pool = requestId
...
export function dutyEmployeeReplyFromExecution(
  result: EmployeeExecuteResponse,
  entry: DutyEmployeeEntry,
): string {
