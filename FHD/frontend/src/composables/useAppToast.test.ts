...
describe('useAppToast', () => {
  it('showAppToast forwards trimmed message and level', () => {
    ...
    expect(message).toHaveBeenCalledWith(expect.objectContaining({ message: 'hello', type: 'success', duration: 1000 }))
  })
  ...
  it('showAppNotification sets title and body', () => {
    ...
    expect(notification).toHaveBeenCalledWith(expect.objectContaining({ title: '标题', message: '正文', duration: 4500 }))
  })
