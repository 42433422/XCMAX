...
export const DEPLOYMENT_MODE_IDS = ['absolute_safe', 'safe', 'performance'] as const
export const DEPLOYMENT_MODES = [
  ...
  },
  {
    ...
    allowsOutbound: true,
    requiresPostgresql: false,
    features: ['AI 能力增强', '数据本地留存', '安全与效率平衡'],
  },
  {
    id: 'performance',
    level: 3,
    ...
    features: ['PostgreSQL 向量索引', '长期记忆', '工具调用', '高性能协作'],
  },
] as DeploymentMode[]
