...
describe('genericModPack', () => {
  ...
  it('shows unified attendance sidebar in enterprise and hides it in admin', () => {
    ...
    expect(shouldHideAttendanceModSidebarMenu('mod-attendance-industry-dashboard')).toBe(false)
    ...
    expect(shouldHideAttendanceModSidebarMenu('attendance-industry-dashboard')).toBe(true)
