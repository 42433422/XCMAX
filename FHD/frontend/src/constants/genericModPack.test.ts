...
describe('genericModPack', () => {
  ...
  it('shows unified attendance sidebar in enterprise and hides it in admin', () => {
    ...
    expect(shouldHideAttendanceModSidebarMenu('mod-attendance-industry-workspace')).toBe(false)
    expect(shouldHideAttendanceModSidebarMenu('mod-attendance-industry-personnel')).toBe(false)
    ...
    expect(shouldHideAttendanceModSidebarMenu('attendance-industry-workspace')).toBe(true)
    expect(shouldHideAttendanceModSidebarMenu('attendance-industry-personnel')).toBe(true)
