...
export const INDUSTRY_PRESETS: Record<string, IndustryPreset> = {
  通用: {
    ...
    quickButtons: [
      ...
      { text: '打印演示客户有限公司的价格表', label: '价格表' },
      { text: '打印演示客户有限公司发货单，编号A001，规格28，一共3桶', label: '开单打印' },
  ...
  管理端: {
    id: '管理端',
    name: '平台运维',
    scenario: 'XCMAX 服务器后台运维。',
    welcomeIntro: '你好，平台运维助手。',
    welcomeBullets: ['查看运维总览', '管理服务器功能'],
    quickButtons: [
      { text: '打开服务器后台总览', label: '运维总览' },
      { text: '查看自动化方针', label: '自动化方针' },
      { text: '服务器功能模块', label: '功能模块' },
      { text: '员工可视化图谱', label: '员工图谱' },
      { text: '测试预览', label: '测试预览' },
    ],
    ...
    uiLabels: { entity: '对象', model_label: '编号', shipment_order: '任务', records: '运维记录' },
  },
}
