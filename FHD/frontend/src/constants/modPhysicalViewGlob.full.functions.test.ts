...
import { modPhysicalViewGlob } from './modPhysicalViewGlob.full'

describe('modPhysicalViewGlob.full loaders', () => {
  ...
  it('loaders can be called concurrently without throwing synchronously', () => {
    const entries = Object.entries(modPhysicalViewGlob)
