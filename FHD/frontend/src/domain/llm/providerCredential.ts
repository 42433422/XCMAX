...
export function providerRowHasUsableKey(row: LlmProviderStatus | undefined | null, fernetConfigured: boolean): boolean {
  if (!row) return false
...
export function buildProviderStatusMap(rows: LlmProviderStatus[] | undefined | null): Record<string, LlmProviderStatus> {
