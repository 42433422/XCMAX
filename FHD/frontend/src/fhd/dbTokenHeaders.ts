...
export async function getProductsReadLockState(_apiBase = '', _options: ProductsReadProbeOptions = {}): Promise<ProductsReadLockState> {
  return 'open'
}

export async function probeProductsReadAccess(_apiBase = '', _options: ProductsReadProbeOptions = {}): Promise<boolean> {
  return true
}
...
export function notifyDbReadTokenRequiredAfter403(_status: number, _requestUrl: string, _method: string): void {}

export function notifyDbWriteTokenRequiredAfter403(_status: number, _requestUrl: string, _method: string): void {}
