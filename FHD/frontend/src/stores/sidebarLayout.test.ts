...
import { DEFAULT_SIDEBAR_WIDTH, MAX_SIDEBAR_WIDTH, MIN_SIDEBAR_WIDTH, useSidebarLayoutStore } from './sidebarLayout'
...
describe('sidebarLayout store', () => {
  ...
  it('loads and persists menu order from storage', () => {
    ...
    expect(JSON.parse(localStorage.getItem('xcagi.sidebar.menuOrder') || '[]')).toEqual(['b', 'a', 'c'])
  })
