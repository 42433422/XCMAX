...
import type { AppDialogAlertOptions, AppDialogConfirmOptions, AppDialogPromptOptions } from '@/stores/appDialog'
...
export function appPrompt(message: string, defaultValue?: string, options?: AppDialogPromptOptions): Promise<string | null> {
