...
describe('erpPagePaths – resolveErpPagePath 边界', () => {
  ...
  it('facade 开启时映射已知路径到 Mod 路径', () => {
    ...
    expect(resolveErpPagePath('/business-docking')).toBe('/mod/xcagi-erp-domain-bridge/business-docking')
...
describe('erpPagePaths – resolveErpPageRedirectForRouteName 边界', () => {
  ...
  it('facade 开启时已知 routeName 返回 Mod 路径', () => {
    ...
    expect(resolveErpPageRedirectForRouteName('business-docking')).toBe('/mod/xcagi-erp-domain-bridge/business-docking')
