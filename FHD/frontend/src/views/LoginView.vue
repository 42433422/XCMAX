...
import { loginAccountInputPlaceholder, loginPageTitle, loginPasswordInputPlaceholder } from '@/constants/loginBranding'
import { fetchProductSku } from '@/utils/productSku'
import { useAccountProfileStore } from '@/stores/accountProfile'
import { DESKTOP_ADMIN_FORBIDDEN_MESSAGE, isAdminConsoleSpa, resolveAdminConsoleLoginUrl } from '@/utils/adminConsoleUrl'
...
.login-input {
  ...
  transition:
    ...
    background var(--xc-transition-fast);
}
