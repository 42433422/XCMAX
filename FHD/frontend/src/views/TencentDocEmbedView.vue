...
const embedUrl = ref((import.meta.env.VITE_TENCENT_DOC_EMBED_URL as string) || 'https://docs.qq.com/demo/embed-placeholder')
...
<template>
  <main class="tdoc-poc">
    <header>
      ...
      <p class="muted">配置 <code>VITE_TENCENT_DOC_EMBED_URL</code> 为腾讯文档 SDK 生成的可嵌入 URL；未配置时显示占位说明。</p>
    </header>
