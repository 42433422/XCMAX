...
class DutyRosterSsotTest {
    @Test
    fun generatedRosterContainsFiftySixUniqueEmployees() {
        assertEquals(56, DutyRosterSsot.PLANNED_EMPLOYEE_COUNT)
        assertEquals(56, DutyRosterSsot.PLANNED_EMPLOYEE_IDS.size)
