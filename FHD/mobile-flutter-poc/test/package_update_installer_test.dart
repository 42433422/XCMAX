...
void main() {
  ...
  test(
    'method channel updater forwards Android delta package config',
    () async {
      ...
      final message =
          await const MethodChannelPackageUpdateInstaller().startPackageUpdate(
      ...
      expect(args['currentVersionCode'], MobileBuildConfig.versionCode);
