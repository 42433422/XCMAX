...
def _profile_blocks(
    ...
    if ms is not None:
        ...
        return [
            ...
            ("afternoon", _facade().time(13, 30), _facade().time(15, 30), profile.block_values[2]),
            ("afternoon", _facade().time(15, 30), _facade().time(17, 30), profile.block_values[3]),
        ]
    first = profile.block_values[0]
    if first <= 1.0:
        return [
            ("morning", _facade().time(9, 0), _facade().time(10, 0), profile.block_values[0]),
            ("morning", _facade().time(10, 0), _facade().time(12, 0), profile.block_values[1]),
            ("afternoon", _facade().time(13, 30), _facade().time(15, 30), profile.block_values[2]),
            ("afternoon", _facade().time(15, 30), _facade().time(17, 30), profile.block_values[3]),
        ]
    return [
        ("morning", _facade().time(8, 0), _facade().time(10, 0), profile.block_values[0]),
        ("morning", _facade().time(10, 0), _facade().time(12, 0), profile.block_values[1]),
        ("afternoon", _facade().time(13, 30), _facade().time(15, 30), profile.block_values[2]),
        ("afternoon", _facade().time(15, 30), _facade().time(17, 30), profile.block_values[3]),
    ]
...
def _default_profile(record: _facade().AttendanceDayRecord) -> _facade().TemplateEmployeeProfile:
