...
ANCHORS: list[tuple[str, str, str]] = [
    ...
    ("config/download_release.json", r'"version_lock"\s*:\s*"([\d.]+)"', PRODUCT_VERSION),
    ("config/download_release.json", r'"marketing_version"\s*:\s*"([\d.]+)"', PRODUCT_VERSION),
    ("config/download_release.json", r'"download_version"\s*:\s*"([\d.]+)"', PRODUCT_VERSION),
    ("config/release_train.json", r'"product_version"\s*:\s*"([\d.]+)"', PRODUCT_VERSION),
    ("config/release_train.json", r'"current"\s*:\s*"([\d.]+)"', PRODUCT_VERSION),
    ("../成都修茈科技有限公司/FHD/config/release_train.json", r'"product_version"\s*:\s*"([\d.]+)"', PRODUCT_VERSION),
    ("../成都修茈科技有限公司/FHD/config/release_train.json", r'"current"\s*:\s*"([\d.]+)"', PRODUCT_VERSION),
