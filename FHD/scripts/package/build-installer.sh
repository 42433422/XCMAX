...
build_one_sku() {
  ...
  # Version the DMG volume name as well as the artifact.  A stale macOS
  # mount-point reservation for a prior generic SKU label can otherwise make
  # hdiutil reject an otherwise valid signed application.
