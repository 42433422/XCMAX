...
# Reuse the imported, unlocked keychain instead of importing the P12 again.
export CSC_LINK="" CSC_KEYCHAIN="${KEYCHAIN_PATH}" CSC_NAME="${CSC_NAME_VALUE}"
...
echo "[ok] CSC_KEYCHAIN=${KEYCHAIN_PATH}"
