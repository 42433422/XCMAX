"""Windows Proactor 10054 噪声过滤器（event_loop_noise.install_proactor_reset_filter）。
...
_PROACOR_LOST_MSG = "Exception in callback _ProactorBasePipeTransport._call_connection_lost(None)"
