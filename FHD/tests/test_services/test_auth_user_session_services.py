...
@patch("app.infrastructure.session.session_manager.get_session_manager")
def test_session_service_validate_expired_deletes(mock_get_mgr):
    mgr = MagicMock()
    ...
    mgr.validate_session.assert_called_once_with("any-id")
