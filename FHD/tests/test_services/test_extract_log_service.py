...
class TestExtractLogService:
    ...
    class TestCreateLog:
        ...
        def test_create_log_without_optional_params(self, mock_get_db, service):
            ...
            log_id = service.create_log(file_name="test.xlsx", data_type="customers")
    ...
    class TestUpdateLog:
        ...
        def test_update_log_pending_status(self, mock_get_db, service):
            ...
            result = service.update_log(log_id=1, status="pending")
        ...
        def test_update_log_failed_status(self, mock_get_db, service):
            ...
            result = service.update_log(log_id=1, status="failed", error_message="文件格式错误")
        ...
        def test_update_log_with_error_message(self, mock_get_db, service):
            ...
            result = service.update_log(log_id=1, status="failed", error_message="数据库连接失败")
