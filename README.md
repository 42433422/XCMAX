...
| **移动 AI 协同 App** | [`FHD/mobile-flutter/`](FHD/mobile-flutter/) | **P2 配套线** — Flutter 统一 Android/iOS · 登录 / 扫码 / 对话 / 审批 / 通知 | [`FHD/mobile-flutter/README.md`](FHD/mobile-flutter/README.md) | [`fhd-ci-mobile-flutter.yml`](.github/workflows/fhd-ci-mobile-flutter.yml) |
...
| [`FHD/mobile-flutter/`](FHD/mobile-flutter/) | **Flutter 移动 AI 协同 App**：Android/iOS 共用业务代码，平台 Runner 仅负责系统能力与发版 |
