...
class ProductAppServiceV2:
    ...
    async def delete_product(self, product_id: str, deleted_by: Optional[str] = None) -> Dict[str, Any]:
        """
        删除产品 - 事件驱动实现
    ...
    async def import_products(self, unit_name: str, products: List[Dict[str, Any]], 
    ...
    async def invalidate_cache(self, product_id: Optional[str] = None, 
