...
class ProductImportAppServiceV2:
    ...
    async def execute_command(self, command_type: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"[ProductImportAppServiceV2] 命令已发布: {command_type} (event_id={event.metadata.event_id})")
...
instrument_application_service_class(ProductImportAppServiceV2, service_name="ProductImportAppServiceV2")
