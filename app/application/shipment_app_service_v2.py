...
class ShipmentAppServiceV2:
    ...
    async def print_shipment(self, shipment_id: str, print_options: Dict[str, Any]) -> Dict[str, Any]:
        """
        打印发货单 - 事件驱动实现
    ...
    async def cancel_shipment(self, shipment_id: str, reason: str, 
                            restore_inventory: bool = True) -> Dict[str, Any]:
        """
        取消发货单 - 事件驱动实现
