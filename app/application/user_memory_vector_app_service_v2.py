"""
user_memory_vector_app_service V2 - 事件驱动版本
...
class UserMemoryVectorAppServiceV2:
    """
    UserMemoryVectorAppService V2 - 事件驱动版本
    """
    ...
    async def execute_command(self, command_type: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            event = NeuroEvent(
                ...
                payload=payload,
                source="usermemoryvectorappservice_v2",
            ...
            logger.info(f"[UserMemoryVectorAppServiceV2] 命令已发布: {command_type} (event_id={event.metadata.event_id})")
            ...
            logger.exception(f"[UserMemoryVectorAppServiceV2] 执行命令失败: {e}")
...
instrument_application_service_class(UserMemoryVectorAppServiceV2, service_name="UserMemoryVectorAppServiceV2")

# 单例管理
_usermemoryvectorappservice_v2_instance = None


def get_user_memory_vector_app_service_v2() -> UserMemoryVectorAppServiceV2:
    """获取 UserMemoryVectorAppServiceV2 单例"""
    global _usermemoryvectorappservice_v2_instance
    if _usermemoryvectorappservice_v2_instance is None:
        _usermemoryvectorappservice_v2_instance = UserMemoryVectorAppServiceV2()
    return _usermemoryvectorappservice_v2_instance
