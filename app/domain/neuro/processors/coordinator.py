...
from app.domain.neuro.reflex_arc import IntentReflexArc, ReflexResult, get_reflex_arc
from app.domain.neuro.processors.subconscious import SubconsciousProcessor, get_subconscious_processor
...
class ProcessorCoordinator:
    ...
    def __init__(
        ...
        subconscious: Optional[SubconsciousProcessor] = None,
        conscious: Optional[ConsciousProcessor] = None,
    ):
    ...
    def route(self, text: str, event: Optional[NeuroEvent] = None) -> RoutingDecision:
        """
        路由决策
...
# 单例
_coordinator: Optional[ProcessorCoordinator] = None
