...
DOMAIN_TO_DIR: dict[str, str] = {
    ...
    "finance": "app/fastapi_routes/domains/finance/",
    "inventory": "app/fastapi_routes/domains/inventory/",
    "lan": "app/fastapi_routes/domains/lan/",
    "market_account": "app/fastapi_routes/domains/market_account/",
    "misc": "app/fastapi_routes/domains/misc/",
    "ocr": "app/fastapi_routes/domains/ocr/",
    "rbac": "app/fastapi_routes/domains/rbac/",
    ...
    "wechat_decrypt": "app/fastapi_routes/domains/wechat_decrypt/",
    "workflow": "app/fastapi_routes/domains/workflow/",
    "xcmax_admin": "app/fastapi_routes/domains/xcmax_admin/",
    "db": "app/fastapi_routes/domains/db/",
}

ALLOWED_LEGACY_FILES: frozenset[str] = frozenset({"xcagi_compat.py", "legacy_gap_registry.py"})
...
LEGACY_ROUTE_REGISTRY: tuple[LegacyRoute, ...] = (
    ...
    _doc("finance", "app.fastapi_routes.domains.finance.routes", "财务看板/凭证"),
    _doc("inventory", "app.fastapi_routes.domains.inventory.routes", "库存"),
    _doc("lan", "app.fastapi_routes.domains.lan.routes", "局域网授权"),
    _doc("market_account", "app.fastapi_routes.domains.market_account.routes", "市场账号"),
    _doc(
        "misc",
        "app.fastapi_routes.domains.misc.helpers",
        "杂项 helpers；compat 聚合见 xcagi_compat.py",
    ),
    _doc("ocr", "app.fastapi_routes.domains.ocr.routes", "OCR"),
    _doc("product", "app.fastapi_routes.domains.product.routes", "产品/商品"),
    _doc("rbac", "app.fastapi_routes.domains.rbac.routes", "RBAC"),
    ...
    _doc("wechat_decrypt", "app.fastapi_routes.domains.wechat_decrypt.routes", "微信解密"),
    _doc("workflow", "app.fastapi_routes.domains.workflow.routes", "工作流/审批"),
    _doc("xcmax_admin", "app.fastapi_routes.domains.xcmax_admin.routes", "XCmax 管理面"),
