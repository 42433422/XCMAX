...
class NeuroBusManager:
    ...
    def __init__(self):
        self._bus: Optional[NeuroBus] = None
        self._started = False
    ...
    def get_bus(self) -> Optional[NeuroBus]:
        """获取总线实例"""
        return self._bus
...
# 全局管理器实例
_neuro_bus_manager: Optional[NeuroBusManager] = None
...
def init_neuro_bus(app: Optional[FastAPI] = None) -> Optional[NeuroBus]:
    """
