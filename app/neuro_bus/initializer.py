...
from app.neuro_bus.event_store import get_event_store, EventStoreMode
...
class NeuroBusInitializer:
    ...
    def initialize(self, event_store_mode: EventStoreMode = EventStoreMode.MEMORY) -> bool:
        ...
        try:
            ...
            logger.info(f"[NeuroBusInitializer] ✓ 事件存储已初始化 (模式: {event_store_mode.value})")
...
# ========== 全局初始化器实例 ==========
_initializer: Optional[NeuroBusInitializer] = None
