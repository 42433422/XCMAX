...
from app.domain.neuro.processors.coordinator import ProcessorCoordinator, get_processor_coordinator, ProcessingReport
...
class NeuroConversationCoordinator:
    ...
    def __init__(
        self,
        base_coordinator: Optional[UnifiedConversationCoordinator] = None,
        processor_coordinator: Optional[ProcessorCoordinator] = None,
    ):
...
# 全局单例
_neuro_coordinator: Optional[NeuroConversationCoordinator] = None
