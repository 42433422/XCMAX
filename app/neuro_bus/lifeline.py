...
class Lifeline:
    ...
    def __init__(
        ...
        # 回调
        self._on_load_change: Optional[Callable[[SystemLoad, SystemLoad], None]] = None
    ...
    def should_process(self, event: NeuroEvent, queue_depth: int) -> bool:
        ...
        with self._lock:
            ...
            # 丢弃
            self._dropped_stats[event.event_type] = \
                self._dropped_stats.get(event.event_type, 0) + 1
