...
| e2e 关键链路 | 5 条 Playwright 在 CI 稳定通过 | **M0 已验证（2026-06-05）**：**mock** — `E2E_VITE_MOCK_API=1` dev :5001、不设 `E2E_FULL_STACK` → `npm run test:e2e:p0` **9 passed / 5 skipped**（`plan2026-skeleton` 5 条 skip，~28s）。**full_stack** — 同上 dev + `E2E_FULL_STACK=1` → **14 passed / 0 failed**（`critical-paths` 5 + `plan2026-skeleton` 5 + `smoke` 4；第 7 次本地复现，~43s；需先 `E2E_VITE_MOCK_API=1 npm run dev -- --port 5001`；`node_modules` 从 `~/XCMAX-archives/m0-venv-20260605/FHD/frontend/node_modules-20260605-rebuild` rsync/符号链接，归档缺 `zod` 时 `npm pack zod@3.25.76` 补入归档副本）。截图 [`evidence/e2e/01–05.png`](evidence/e2e/README.md)。CI：仓根 [`e2e.yml`](../../.github/workflows/e2e.yml) → [`e2e-playwright-reusable.yml`](../.github/workflows/e2e-playwright-reusable.yml)；`E2E_VITE_MOCK_API=1` 契约 mock + 可选 Postgres 全栈 | 一致 | 前端 + QA | [`frontend/e2e/README.md`](../frontend/e2e/README.md)、[`evidence/e2e/`](evidence/e2e/) |
