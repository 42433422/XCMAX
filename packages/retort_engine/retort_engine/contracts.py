...
RETORT_CONTRACT_SCHEMAS: dict[str, tuple[str, ...]] = {
    ...
    "external_advantage_ci_regression_result": ("status", "project", "summary", "cases", "evidence"),
    "external_process_adjudication_result": ("status", "project", "summary", "cases", "artifacts", "evidence"),
    "external_advantage_repeat_result": ("status", "project", "summary", "runs", "evidence"),
    "upstream_pr_ci_probe_result": ("status", "project", "summary", "pull_request", "check_runs", "evidence"),
    ...
    "external_merge_landing_result": ("status", "project", "summary", "cases", "evidence"),
