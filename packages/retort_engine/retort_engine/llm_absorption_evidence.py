...
def _report_evidence(project: Path) -> list[str]:
    ...
    return [
        ...
        f"upstream_pr_ci_probe_language_families={upstream_pr_ci_summary.get('language_family_count', '')}",
        f"upstream_pr_ci_probe_cross_language_generalization={upstream_pr_ci_summary.get('cross_language_ci_generalization', '')}",
        ...
        f"upstream_pr_ci_probe_blocking_checks={upstream_pr_ci_summary.get('total_blocking_check_run_count', '')}",
        ...
        f"competitor_runtime_comparison_force_live_refresh={competitor_runtime_summary.get('force_live_refresh', '')}",
        ...
        f"competitor_runtime_comparison_live_refresh_used={competitor_runtime_summary.get('live_refresh_used_count', '')}/{competitor_runtime_summary.get('competitor_project_count', '')}",
        f"competitor_runtime_comparison_all_sources_from_live_refresh={competitor_runtime_summary.get('all_runtime_sources_from_live_refresh', '')}",
        ...
        f"competitor_blind_adjudication_no_human_model={(competitor_blind.get('evidence') or {}).get('no_human_operating_model', '') if isinstance(competitor_blind.get('evidence'), dict) else ''}",
        f"competitor_blind_adjudication_human_required={(competitor_blind.get('evidence') or {}).get('human_review_required', '') if isinstance(competitor_blind.get('evidence'), dict) else ''}",
        ...
        f"paibi_cli_cross_adjudication_no_human_model={paibi_cli_cross_summary.get('no_human_operating_model', '')}",
        f"paibi_cli_cross_adjudication_human_required={paibi_cli_cross_summary.get('human_review_required', '')}",
        f"paibi_cli_cross_adjudication_human_not_applicable={paibi_cli_cross_summary.get('human_review_not_applicable', '')}",
        f"paibi_cli_cross_adjudication_oracle_calibrated={paibi_cli_cross_summary.get('oracle_calibrated_cli_consensus', '')}",
        ...
        f"paibi_cli_cross_adjudication_calibration_labels={paibi_cli_cross_summary.get('calibration_label_count', '')}",
        f"paibi_cli_cross_adjudication_calibration_source={paibi_cli_cross_summary.get('calibration_label_source_type', '')}",
        ...
        f"review_adjudication_no_human_model={adjudication_summary.get('no_human_operating_model', '')}",
        f"review_adjudication_human_required={adjudication_summary.get('human_review_required', '')}",
        f"review_adjudication_calibration_label_count={adjudication_summary.get('calibration_label_count', '')}",
        f"review_adjudication_label_source_type={adjudication_summary.get('label_source_type', '')}",
        ...
        f"absorption_release_decision_paibi_cli_cross_no_human_model={release_summary.get('paibi_cli_cross_adjudication_no_human_model', '')}",
        f"absorption_release_decision_paibi_cli_cross_human_required={release_summary.get('paibi_cli_cross_adjudication_human_required', '')}",
        f"absorption_release_decision_paibi_cli_cross_oracle_calibrated={release_summary.get('paibi_cli_cross_adjudication_oracle_calibrated', '')}",
