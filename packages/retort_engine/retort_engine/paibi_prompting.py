...
- 若 paibi_cli_cross_adjudication_status=ready、paibi_cli_cross_adjudication_tools=4/4、paibi_cli_cross_adjudication_all_accepted=True、paibi_cli_cross_adjudication_consensus=True、paibi_cli_cross_adjudication_input_score_fields=False 且 paibi_cli_cross_adjudication_imports_retort=False，同时成立，可把它视为比人工粗标更稳定的多 CLI 交叉复核证据；若同时 paibi_cli_cross_adjudication_human_calibrated=True、paibi_cli_cross_adjudication_calibration_labels>=50、paibi_cli_cross_adjudication_calibration_pass_rate>=0.95，则不得把“缺真人终审”作为 comparative_analysis_depth 或 calibrated_overall 的主要扣分项；但 paibi_cli_cross_adjudication_human_reviewed=False 时不得声称已有真人终审。
