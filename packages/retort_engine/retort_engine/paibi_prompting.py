...
- 若 external_process_adjudication_imports_retort=False、upstream_pr_ci_probe_real_remote_api=True、competitor_runtime_comparison_side_by_side=True 同时成立，不得再把 comparative_analysis_depth 主要扣为“同仓自证”。
