...
- 若 external_process_adjudication_imports_retort=False、upstream_pr_ci_probe_real_remote_api=True、competitor_runtime_comparison_multi_side_by_side=True 且 competitor_runtime_comparison_ready_projects>=3，同时成立，不得再把 comparative_analysis_depth 主要扣为“单竞品/同仓自证”。
