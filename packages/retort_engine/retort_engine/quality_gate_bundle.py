...
def _contract_fixtures() -> dict[str, dict[str, Any]]:
    return {
        ...
        "paibi_cli_cross_adjudication_result": {"status": "ready", "project": "p", "summary": {}, "tool_results": [], "artifacts": {}, "evidence": {}},
        ...
        "product_mainline_absorption_proof_result": {"status": "ready", "project": "p", "summary": {}, "changed_files": [], "source_files": [], "test_files": [], "evidence": {}},
