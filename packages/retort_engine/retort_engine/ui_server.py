        ...
        class Handler(BaseHTTPRequestHandler):
            ...
            def do_POST(self) -> None:
                ...
                try:
                    if self.path == "/api/assess":
                    ...
                    elif self.path == "/api/review-pipeline-diff-replay":
                        self._json(outer.service.review_pipeline_diff_replay(payload))
                    ...
                    elif self.path == "/api/pr-failure-rollback-replay":
                        self._json(outer.service.pr_failure_rollback_replay(payload))
                        ...
                        self._json(outer.service.architecture_contract_report(payload))
                        ...
                        self._json(outer.service.competitor_runtime_comparison(payload))
                    elif self.path == "/api/upstream-pr-ci-probe":
                        self._json(outer.service.upstream_pr_ci_probe(payload))
