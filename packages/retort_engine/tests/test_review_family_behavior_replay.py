...
def test_review_family_behavior_replay_verifies_typescript_and_python_outputs(
    tmp_path: Path,
) -> None:
    ...
    assert (
        validate_contract("review_family_behavior_replay_result", result)["valid"]
        is True
    )
...
def test_review_family_behavior_replay_cli_outputs_contract(tmp_path: Path) -> None:
    ...
    assert (
        validate_contract("review_family_behavior_replay_result", payload)["valid"]
        is True
    )
