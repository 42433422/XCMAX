...
def print_report(stats):
    ...
    for stat in module_stats:
        print(f"{stat['module']:<25} {stat['neuro']:>8} {stat['traditional']:>12} "
    ...
    print(f"{'TOTAL':<25} {total_neuro:>8} {total_traditional:>12} "
    ...
    for i, file_info in enumerate(all_files[:10], 1):
        ...
        print(f"    Neuro: {file_info['neuro']}, Traditional: {file_info['traditional']}, Ratio: {ratio:.1f}%")
