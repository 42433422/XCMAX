...
cur.execute("SELECT id, name, model_number, specification, price, is_active FROM products WHERE model_number IN ('3721', '1870D', '8828') ORDER BY model_number, specification")
for row in cur.fetchall():
    print(row)
