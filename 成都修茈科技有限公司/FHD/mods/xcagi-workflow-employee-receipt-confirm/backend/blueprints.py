...
EMPLOYEE_STEM = "receipt_confirm"
EMPLOYEE_LABEL = "收货确认 AI 员工"
...
async def _dispatch_run(
    mod_id: str, emp_id: str, stem: str, payload: Optional[Dict[str, Any]]
):
...
def register_fastapi_routes(app, mod_id: str) -> None:
    ...
    async def emp_status():
        return await _dispatch_run(
            mod_id, EMPLOYEE_ID, EMPLOYEE_STEM, {"action": "status"}
        )
