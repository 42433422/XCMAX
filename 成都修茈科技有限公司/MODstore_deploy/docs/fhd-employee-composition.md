...
**MODstore 侧「员工包脚手架」按部门预设默认能力**（与 FHD A/B/C 概念独立）：见 [`employee-scaffold-presets.md`](./employee-scaffold-presets.md)。
...
_可与 `docs/workbench-employee-impl-flow.md`、`docs/workbench-make-mod-workflow.md` 交叉阅读。_
