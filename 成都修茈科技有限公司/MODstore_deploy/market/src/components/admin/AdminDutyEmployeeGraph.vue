...
.dg-header-right { grid-area: right; display: flex; align-items: center; gap: 8px; flex-shrink: 0; flex-wrap: wrap; justify-self: end; }
.dg-header-actions {
  grid-area: actions;
  display: flex;
  align-items: center;
...
/* ─── Flow wrap ──────────────────────────────────────────────────────────── */
.dg-flow-wrap { flex:1; display:flex; overflow:hidden; position:relative; z-index:0; min-height:0; }
.dg-flow      { flex:1; background:var(--dg-flow-bg, var(--color-bg-body,#0a0a14)); min-height:0; }
