/**
 * 员工大会（All-Hands）面板：会期编排 / 汇报 / 综合答复 / 会议纪要。
 *
...
import { formatDurationMs, formatTime, isVirtualEmployee } from './adminDutyConstants'
import type { AdminDutyAllHands } from './useAdminDutyAllHands'
import type { AdminDutyState } from './useAdminDutyState'
import MessageBody from '../../workbench/MessageBody.vue'

const emit = defineEmits<{
  (e: 'update:allHandsWithResearch', v: Deref<AdminDutyState['allHandsWithResearch']>): void
  (e: 'update:showAllHandsPanel', v: Deref<AdminDutyState['showAllHandsPanel']>): void
  (e: 'update:allHandsQuestion', v: Deref<AdminDutyState['allHandsQuestion']>): void
}>()

const props = defineProps<{
  allHandsWithResearch: Deref<AdminDutyState['allHandsWithResearch']>
  showAllHandsPanel: Deref<AdminDutyState['showAllHandsPanel']>
  allHandsQuestion: Deref<AdminDutyState['allHandsQuestion']>
  allHandsBusy: Deref<AdminDutyState['allHandsBusy']>
  allHandsError: Deref<AdminDutyState['allHandsError']>
  allHandsExpanded: Deref<AdminDutyState['allHandsExpanded']>
  allHandsMeetingMinutes: Deref<AdminDutyState['allHandsMeetingMinutes']>
  allHandsMeetingMinutesEmail: Deref<AdminDutyState['allHandsMeetingMinutesEmail']>
  allHandsPlainLoading: Deref<AdminDutyState['allHandsPlainLoading']>
  allHandsPlainOpen: Deref<AdminDutyState['allHandsPlainOpen']>
  allHandsPlainText: Deref<AdminDutyState['allHandsPlainText']>
  allHandsProgress: Deref<AdminDutyState['allHandsProgress']>
  allHandsReport: Deref<AdminDutyState['allHandsReport']>
  allHandsSessionId: Deref<AdminDutyState['allHandsSessionId']>
  employees: Deref<AdminDutyState['employees']>
  allHandsAreaPalette: Record<string, string>
  askAllHandsQuestion: Deref<AdminDutyAllHands['askAllHandsQuestion']>
  copyAllHandsMeetingMinutes: Deref<AdminDutyAllHands['copyAllHandsMeetingMinutes']>
  downloadAllHandsMeetingMinutes: Deref<AdminDutyAllHands['downloadAllHandsMeetingMinutes']>
  focusAllHandsEmployee: Deref<AdminDutyAllHands['focusAllHandsEmployee']>
  publishFollowUpToButler: Deref<AdminDutyAllHands['publishFollowUpToButler']>
  requestPlainLang: Deref<AdminDutyAllHands['requestPlainLang']>
  runAllHands: Deref<AdminDutyAllHands['runAllHands']>
  toggleAllHandsRow: Deref<AdminDutyAllHands['toggleAllHandsRow']>
}>()
