...
const emit = defineEmits<{
  (e: 'update:showNoKeyPanel', v: Deref<AdminDutyState['showNoKeyPanel']>): void
}>()

const props = defineProps<{
  showNoKeyPanel: Deref<AdminDutyState['showNoKeyPanel']>
  noKeyLoading: Deref<AdminDutyState['noKeyLoading']>
  noKeyError: Deref<AdminDutyState['noKeyError']>
  noKeyData: Deref<AdminDutyState['noKeyData']>
  noKeyBusyRow: Deref<AdminDutyState['noKeyBusyRow']>
  loadNoKeyEmployees: Deref<AdminDutyNoKey['loadNoKeyEmployees']>
  alignSingleEmployeeToAuto: Deref<AdminDutyNoKey['alignSingleEmployeeToAuto']>
  gotoAddKey: Deref<AdminDutyNoKey['gotoAddKey']>
}>()
