...
export const YUANGON_PKG_DESCRIPTIONS: Record<string, string> = {
  ...
  'llm-ops-engineer': '负责 LLM API key 健康检查、真实额度与成本追踪、模型选型、全平台 AI 资产接口盘点（聊天/生图/生视频/音频/嵌入/CLI），并通过后台巡检主动切换所有平台 AI 员工的运行时模型；切换前确认额度、密钥、目录与健康，切换后复验并在失败时自动回滚。',
  ...
  'mobile-android-release-officer': 'Flutter Android 渠道构建与发布：统一 Flutter CI、release-android、签名 APK/AAB 与真机 smoke。',
  'mobile-ios-release-officer': 'Flutter iOS 渠道发布：Runner、Fastlane match、签名、TestFlight / App Store Connect 上传与 release 门禁。',
