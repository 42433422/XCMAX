...
html[data-workbench-theme='light'] .page-sub {
  color: #86868b;
}
html[data-workbench-theme='light'] .entitlement-card {
  border-color: rgba(0, 0, 0, 0.08);
  background: #ffffff;
}
html[data-workbench-theme='light'] .entitlement-card h3 {
  color: #1d1d1f;
}
html[data-workbench-theme='light'] .plan-expire {
  color: #86868b;
}
html[data-workbench-theme='light'] .quota-pill {
...
html[data-workbench-theme='light'] .artifact-badge {
  background: rgba(0, 0, 0, 0.04);
  color: #86868b;
}
html[data-workbench-theme='light'] .artifact-employee_pack {
  background: rgba(0, 113, 227, 0.08);
  color: #0071e3;
}
html[data-workbench-theme='light'] .artifact-bundle {
  background: rgba(245, 158, 11, 0.08);
  color: #b45309;
}
html[data-workbench-theme='light'] .artifact-mod {
  background: rgba(0, 113, 227, 0.08);
  color: #0071e3;
}
html[data-workbench-theme='light'] .mod-name {
  color: #1d1d1f;
}
html[data-workbench-theme='light'] .mod-meta {
  color: rgba(0, 0, 0, 0.3);
}
html[data-workbench-theme='light'] .mod-purchase-info {
  color: #86868b;
}
...
html[data-workbench-theme='light'] .empty-state > p:first-of-type {
  color: #1d1d1f;
}
