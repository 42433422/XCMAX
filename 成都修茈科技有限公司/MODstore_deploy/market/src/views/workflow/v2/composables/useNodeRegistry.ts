  ...
  employee: {
    ...
    fields: [
      ...
      },
      {
        ...
        label: '任务描述',
        type: 'textarea',
        placeholder: '该员工要完成的任务，可使用 {{ input.field }}',
      },
  ...
  eskill: {
    ...
    fields: [
      ...
      },
      {
        ...
        label: '任务覆盖',
        type: 'textarea',
        placeholder: '可选：覆盖 Skill 内部 task_template',
      },
      { key: 'output_var', label: '输出变量名', type: 'text', placeholder: '默认 eskill_output' },
      {
        ...
        label: '质量门槛 (JSON)',
        type: 'json',
        placeholder: '{"min_length": 24}',
      },
      {
        key: 'trigger_policy',
        label: '触发策略 (JSON)',
        type: 'json',
        placeholder: '{"on_error": true}',
      },
    ...
    fields: [
      {
        ...
        type: 'number',
        required: true,
        helper: '从 /api/openapi-connectors 中选取',
      },
    ...
    fields: [
      {
        ...
        label: 'HMAC 共享密钥',
        type: 'text',
        helper: '留空则使用全局默认密钥；建议每个工作流独立设置',
      },
    ...
    fields: [
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'result = input.get("key", "default")',
      },
      { key: 'output_var', label: '输出变量名', type: 'text' },
      { key: 'timeout', label: '超时(秒)', type: 'number' },
    ],
    ...
    fields: [
      {
        ...
        type: 'json',
        required: true,
        placeholder: '[{"type": "field_map", "mapping": {"name": "user_name"}}]',
      },
      { key: 'output_var', label: '输出变量名', type: 'text' },
    ],
  },
    ...
    fields: [
      {
        ...
        type: 'json',
        required: true,
        placeholder: '[{"name": "branch_a", "type": "pass"}]',
      },
      { key: 'output_var', label: '输出变量名', type: 'text' },
    ],
  },
