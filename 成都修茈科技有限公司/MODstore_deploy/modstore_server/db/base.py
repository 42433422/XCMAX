...
def _ensure_columns(engine: Engine) -> None:
    patches: list[tuple[str, str, str]] = [
        ...
        ("users", "enterprise_subject_id", "VARCHAR(128)"),
        ("users", "enterprise_legal_name", "VARCHAR(256)"),
        ("users", "enterprise_verification_sha256", "VARCHAR(64)"),
        ("users", "enterprise_verified_at", "DATETIME"),
        ("users", "enterprise_verified_by_user_id", "INTEGER"),
