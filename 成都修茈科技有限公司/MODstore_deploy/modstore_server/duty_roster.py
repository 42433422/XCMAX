...
SIX_LINE_DEPARTMENTS: Dict[str, Dict[str, object]] = {
    ...
    "ops_partner": {
        ...
        "subzones": {
            "partner-onboard": {
                "label": "生态接入 B1",
                "ids": ["ecosystem-partner-onboard-officer"],
            },
            "joint-catalog": {
                "label": "联合 catalog B2",
                "ids": ["ecosystem-joint-catalog-officer"],
            },
            "delivery-bridge": {"label": "生态交付 B3", "ids": ["ecosystem-delivery-reporter"]},
            "investor-portal": {
                "label": "投资方视图 B4",
                "ids": ["ecosystem-investor-portal-officer"],
            },
            "revenue-share": {
                "label": "分润对账 B5",
                "ids": ["ecosystem-revenue-share-reconciler"],
            },
        },
    },
    "prod_web": {
        ...
        "subzones": {
            ...
            "docs-seo": {
                "label": "文档 SEO P1e",
                "ids": ["doc-knowledge-curator", "seo-sitemap-curator"],
            },
            "nginx-deploy": {
                "label": "nginx 部署 P1f",
                "ids": ["nginx-config-engineer", "deploy-release-officer"],
            },
        },
    },
    "prod_mod": {
        ...
        "subzones": {
            ...
            "mod-ota": {
                "label": "Mod OTA P6",
                "ids": ["push-update-context-officer", "pack-registrar"],
            },
            "roster-quality": {
                "label": "编制质检",
    ...
    "shared_retention": {
        ...
        "subzones": {
            ...
            "legacy-archive": {
                "label": "legacy 归档 R3",
                "ids": ["retention-officer", "legacy-archive-curator"],
            },
            "alert-cve": {
                "label": "告警 CVE R4",
