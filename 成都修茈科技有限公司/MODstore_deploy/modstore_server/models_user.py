...
class User(Base):
    ...
    enterprise_subject_id = Column(String(128), nullable=True, index=True)
    enterprise_legal_name = Column(String(256), nullable=True)
    ...
    avatar_path = Column(String(512), nullable=False, default="")
    avatar_version = Column(Integer, default=0, nullable=False)
