"""将 avatar-generation-employee 发布到 catalog 并设为 AI 市场公开展示。"""
...
PKG_ID = "avatar-generation-employee"
META = {
    "name": "头像生成员",
    "description": (
        "覆盖真人、关系、动漫游戏、插画化本人、职业品牌、宠物吉祥物、兴趣符号、"
        "抽象氛围、默认极简九类头像，为 AI 员工生成头像提示词并可选调用生图模型；"
        "内置批量员工头像表、小 C 人形鱼系助理、单员工移动端联系人头像三套预设。"
    ),
    "industry": "创意/视觉",
}
