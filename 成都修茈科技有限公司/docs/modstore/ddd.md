...
| **历史兼容路由**      | `**app/fastapi_routes/`\*_ 内的 `xcagi_compat`、`archive_gap_batch_`、`miniprogram`、`approval` 等 | 原 `backend.routers.*` 2026-04-20 起已迁至此处,统一由 `app.fastapi_routes.register_all_routes` 挂载                                                   |
...
- `/api/template`、`/api/word/`_、`/api/excel/_` — 模板与文档处理
