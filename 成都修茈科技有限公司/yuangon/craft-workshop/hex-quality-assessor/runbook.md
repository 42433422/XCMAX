        # Runbook：六维质检员工 (`hex-quality-assessor`)
        ...
        ### handoff: quality-validator → 本岗
- **触发条件**：`employee.task.done:quality-validator`
- **输入**：待补充（参见 `yuangon/**/quality-validator/runbook.md`）
- **门禁**：依赖完成前本岗不得继续
...
- `workbench/validation/*`
        ...
        | 场景 | 处置 |
        |------|------|
        | LLM 调用失败 | retry 2 次 → 上报 `employee.task.failed:hex-quality-assessor` |
