...
2. 严格避开禁区：MODstore*deploy/market/src/**、MODstore_deploy/modstore_server/models.py、MODstore_deploy/modstore_server/migrations/**、MODstore_deploy/modstore_server/payment*_.py、\_local_secrets/\*\*、_.env\*。
